...
public class SingleSignOnEPRPCCTest 
{
    ...
    public static void main( String[] iargs )
    {
    	...
    	String iPCC = "0FJG";
    	String iFileName   = "/Users/sameerbasha/Desktop/2024/SabreSingleSignOn/ATKKey.txt";
    	...
    	try {
	    	...
	    	//wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div/article/section/div/div/h3")));
	    	
	    	
	    	System.out.println("Entering Data..." );
	    	// Go ahead and enter the values now
	    	driver.findElement(By.xpath("//*[@id=\"userId\"]")).sendKeys(iEPR);
	    	driver.findElement(By.xpath("//*[@id=\"password\"]")).sendKeys(iPassword);
	    	driver.findElement(By.xpath("//*[@id=\"group\"]")).sendKeys(iPCC);
